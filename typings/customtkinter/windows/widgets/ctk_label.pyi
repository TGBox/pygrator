...
class CTkLabel(CTkBaseClass):
    def __init__(self, master: Any, width: int = 0, height: int = 28, corner_radius: int | None = None, border_width: int | None = None, bg_color: str | tuple[str, str] = 'transparent', fg_color: str | tuple[str, str] | None = None, border_color: str | tuple[str, str] | None = None, text_color: str | tuple[str, str] | None = None, text_color_disabled: str | tuple[str, str] | None = None, text: str = 'CTkLabel', font: tuple | CTkFont | None = None, image: CTkImage | None = None, compound: str = 'center', anchor: str = 'center', wraplength: int = 0, **kwargs) -> None: ...
