...
class CTkTabview(CTkBaseClass):
    def __init__(self, master: Any, width: int = 300, height: int = 250, corner_radius: int | None = None, border_width: int | None = None, bg_color: str | tuple[str, str] = 'transparent', fg_color: str | tuple[str, str] | None = None, border_color: str | tuple[str, str] | None = None, segmented_button_fg_color: str | tuple[str, str] | None = None, segmented_button_selected_color: str | tuple[str, str] | None = None, segmented_button_selected_hover_color: str | tuple[str, str] | None = None, segmented_button_unselected_color: str | tuple[str, str] | None = None, segmented_button_unselected_hover_color: str | tuple[str, str] | None = None, segmented_button_font: tuple | CTkFont | None = None, text_color: str | tuple[str, str] | None = None, text_color_disabled: str | tuple[str, str] | None = None, command: Callable | Any = None, anchor: str = 'center', state: str = 'normal', **kwargs) -> None: ...
